...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/3m/c3m7vhqjacyr3myou537nv6mqw4pgreork2c5zclwxnrmenvl4tc.py
...
#   %add : Tensor "bf16[4096, 8, 1024][8192, 1024, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_1, %primals_2), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_add_0.run(primals_1, primals_2, buf0, 33554432, stream=stream0)
            del primals_1
            del primals_2
        return (buf0, )
