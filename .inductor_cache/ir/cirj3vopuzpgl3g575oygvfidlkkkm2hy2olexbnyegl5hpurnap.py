...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/qx/cqxprikrk7ryxylnxpete26xxyustxud66dywvfnmqbwegl3zaha.py
...
#   %view : Tensor "f32[16384, 50304][50304, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%arg0_1, [-1, 50304]), kwargs = {})
#   %iota : Tensor "i64[16384][1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.iota.default](args = (16384,), kwargs = {start: 0, step: 1, dtype: torch.int64, device: cuda:2, requires_grad: False})
#   %index : Tensor "f32[16384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%view, [%iota, %arg2_1]), kwargs = {})
#   %view_1 : Tensor "b8[16384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%arg1_1, [-1]), kwargs = {})
#   %convert_element_type : Tensor "f32[16384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_1, torch.float32), kwargs = {})
#   %sub : Tensor "f32[16384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (1.0, %convert_element_type), kwargs = {})
#   %sub_1 : Tensor "f32[16384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%index, %sub), kwargs = {})
#   %index_put : Tensor "f32[16384, 50304][50304, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.index_put.default](args = (%view, [%iota, %arg2_1], %sub_1), kwargs = {})
#   return %index_put
...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/eg/cegmfxxnzqbnnml6bdwnp5en5ufe2xooktgo5dzgngvztmdm2sjs.py
# Topologically Sorted Source Nodes: [grad_2d, arange_1d, getitem, view_1, float_1, softmax_update, isub, setitem], Original ATen: [aten.view, aten.arange, aten.index, aten._to_copy, aten.rsub, aten.sub, aten.index_put]
# Source node to ATen node mapping:
#   arange_1d => iota
#   float_1 => convert_element_type
...
#   view_1 => view_1
# Graph fragment:
#   %arg2_1 : Tensor "i64[16384][1]cuda:2" = PlaceHolder[target=arg2_1]
#   %copy_ : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:2" = PlaceHolder[target=copy_]
#   %arg1_1 : Tensor "b8[4096, 4][4, 1]cuda:2" = PlaceHolder[target=arg1_1]
#   %index_put : Tensor "f32[16384, 50304][50304, 1]cuda:2" = PlaceHolder[target=index_put]
#   %view : Tensor "f32[16384, 50304][50304, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%arg0_1, [-1, 50304]), kwargs = {})
#   %iota : Tensor "i64[16384][1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.iota.default](args = (16384,), kwargs = {start: 0, step: 1, dtype: torch.int64, device: cuda:2, requires_grad: False})
#   %index : Tensor "f32[16384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.index.Tensor](args = (%view, [%iota, %arg2_1]), kwargs = {})
#   %view_1 : Tensor "b8[16384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%arg1_1, [-1]), kwargs = {})
...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/nf/cnfjypfx52fanqppq76rryukxp253qlctmujjz3hg6lev7aug42g.py
...
#   unsqueeze => unsqueeze
# Graph fragment:
#   %buf1 : Tensor "f32[16384, 50304][50304, 1]cuda:2" = PlaceHolder[target=buf1]
#   %arg3_1 : Tensor "f32[4096, 4][1, 4096]cuda:2" = PlaceHolder[target=arg3_1]
#   %mul : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:2" = PlaceHolder[target=mul]
#   %copy_ : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:2" = PlaceHolder[target=copy_]
#   %view_2 : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%index_put, [4096, 4, 50304]), kwargs = {})
#   %unsqueeze : Tensor "f32[4096, 4, 1][1, 4096, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%arg3_1, -1), kwargs = {})
#   %mul : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_2, %unsqueeze), kwargs = {})
#   %convert_element_type_1 : Tensor "bf16[4096, 4, 50304][201216, 50304, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul, torch.bfloat16), kwargs = {})
#   %copy_ : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:2"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg0_1, %mul), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            triton_poi_fused__to_copy_arange_index_index_put_rsub_sub_view_0.run(arg0_1, buf0, 824180736, stream=stream2)
            # Topologically Sorted Source Nodes: [grad_2d, arange_1d, getitem, view_1, float_1, softmax_update, isub, setitem], Original ATen: [aten.view, aten.arange, aten.index, aten._to_copy, aten.rsub, aten.sub, aten.index_put]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_arange_index_index_put_rsub_sub_view_1.run(arg2_1, arg0_1, arg1_1, buf0, 16384, stream=stream2)
            del arg1_1
            del arg2_1
            buf2 = empty_strided_cuda((4096, 4, 50304), (201216, 50304, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [setitem, unsqueeze, mul_, grad_input], Original ATen: [aten.view, aten.unsqueeze, aten.mul, aten._to_copy, aten.copy_]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_copy__mul_unsqueeze_view_2.run(buf0, arg3_1, buf2, arg0_1, 824180736, stream=stream2)
            del arg0_1
            del arg3_1
            del buf0
        return (buf2, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg1_1 = rand_strided((4096, 4), (4, 1), device='cuda:2', dtype=torch.bool)
    arg2_1 = rand_strided((16384, ), (1, ), device='cuda:2', dtype=torch.int64)
    arg3_1 = rand_strided((4096, 4), (1, 4096), device='cuda:2', dtype=torch.float32)
