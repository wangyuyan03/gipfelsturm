...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/rp/crp7stfcqxuxrsvpagwmsy7ofb3urdlzoh552h56fe4sdr6l5qtd.py
...
#   %add : Tensor "bf16[4096, 8, 1024][8192, 1024, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_1, %primals_2), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(1):
            ...
            triton_poi_fused_add_0.run(primals_1, primals_2, buf0, 33554432, stream=stream1)
            del primals_1
            del primals_2
        return (buf0, )
