...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/no/cnohp4nfnlgct6zg7pkonw2vh7uzj3dkd7epgcpzfvasxmjmnorx.py
...
#   split => split
# Graph fragment:
#   %arg0_1 : Tensor "f32[8192, 4][4, 1]cuda:0" = PlaceHolder[target=arg0_1]
#   %split : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%arg0_1, 4096), kwargs = {})
#   %log : Tensor "f32[4096, 4][4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.log.default](args = (%getitem_1,), kwargs = {})
#   %sub : Tensor "f32[4096, 4][4, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%log, %getitem), kwargs = {})
#   return %sub
...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/hi/chigntgycg6mmdnofuhlvbctveumjqcc3irauhzujwwvdmzl5aai.py
...
#   %arg0_1 : Tensor "f32[8192, 4][4, 1]cuda:0" = PlaceHolder[target=arg0_1]
#   %div : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:0" = PlaceHolder[target=div]
#   %split : [num_users=2] = call_function[target=torch.ops.aten.split.Tensor](args = (%arg0_1, 4096), kwargs = {})
#   %unsqueeze : Tensor "f32[4096, 4, 1][4, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%getitem_1, -1), kwargs = {})
#   %div : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%arg1_1, %unsqueeze), kwargs = {})
#   %copy_ : Tensor "f32[4096, 4, 50304][201216, 50304, 1]cuda:0"[num_users=0] = call_function[target=torch.ops.aten.copy_.default](args = (%arg1_1, %div), kwargs = {})
#   return %div,%buf2
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_log_split_sub_0.run(arg0_1, buf0, 16384, stream=stream0)
            # Topologically Sorted Source Nodes: [split, unsqueeze, div_], Original ATen: [aten.split, aten.unsqueeze, aten.div, aten.copy_]
            stream0 = get_raw_stream(0)
            triton_poi_fused_copy__div_split_unsqueeze_1.run(arg1_1, arg0_1, arg1_1, 824180736, stream=stream0)
            del arg0_1
            del arg1_1
        return (buf0, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((8192, 4), (4, 1), device='cuda:0', dtype=torch.float32)
    arg1_1 = rand_strided((4096, 4, 50304), (201216, 50304, 1), device='cuda:0', dtype=torch.float32)
