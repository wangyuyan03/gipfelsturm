...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/y3/cy3qazvyphn5dhmoz6crz7hp5uyfsgubcr6kespabwv276mzyctp.py
...
# Graph fragment:
#   %arg0_1 : Tensor "bf16[4096, 8, 50304][402432, 50304, 1]cuda:2" = PlaceHolder[target=arg0_1]
#   %convert_element_type : Tensor "f32[4096, 8, 50304][402432, 50304, 1]cuda:2" = PlaceHolder[target=convert_element_type]
#   %convert_element_type : Tensor "f32[4096, 8, 50304][402432, 50304, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg0_1, torch.float32), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            triton_red_fused__to_copy_max_0.run(arg0_1, buf0, buf1, 32768, 50304, stream=stream2)
            del arg0_1
        return (buf0, buf1, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((4096, 8, 50304), (402432, 50304, 1), device='cuda:2', dtype=torch.bfloat16)
