...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/df/cdfgw32e6c736mruc6v2alb7hqxllwibtob43rm5ujxr74twrtkj.py
...
#   %add : Tensor "bf16[4096, 8, 1024][8192, 1024, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_1, %primals_2), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(3):
            ...
            triton_poi_fused_add_0.run(primals_1, primals_2, buf0, 33554432, stream=stream3)
            del primals_1
            del primals_2
        return (buf0, )
