...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/66/c66ynmkxa7hry4ozwejjhyce7ahaaxdcclv7zzgb5sbfrjffcd67.py
...
#   %add : Tensor "bf16[4096, 4, 1536][6144, 1536, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_1, %primals_2), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_poi_fused_add_0.run(primals_1, primals_2, buf0, 25165824, stream=stream0)
            del primals_1
            del primals_2
        return (buf0, )
