...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/mg/cmgzxc56vootxjako6na7dmwuof6wtielg24awulkxef6d2qaa76.py
...
# Graph fragment:
#   %arg0_1 : Tensor "bf16[4096, 16, 50304][804864, 50304, 1]cuda:1" = PlaceHolder[target=arg0_1]
#   %convert_element_type : Tensor "f32[4096, 16, 50304][804864, 50304, 1]cuda:1" = PlaceHolder[target=convert_element_type]
#   %convert_element_type : Tensor "f32[4096, 16, 50304][804864, 50304, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg0_1, torch.float32), kwargs = {})
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'xnumel': 'i64', 'r0_numel': 'i64', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=1, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]]}], 'enable_fp_fusion': True},
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(1):
            ...
            triton_red_fused__to_copy_max_0.run(arg0_1, buf0, buf1, 65536, 50304, stream=stream1)
            del arg0_1
        return (buf0, buf1, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((4096, 16, 50304), (804864, 50304, 1), device='cuda:1', dtype=torch.bfloat16)
