...
# kernel path: /iopsstor/scratch/cscs/course_00313/gipfelsturm/.inductor_cache/ic/cict4xtysjaktcxh4pmjz246oqqt6kznmlrmvdhyskk2dczltff5.py
...
#   %add : Tensor "bf16[4096, 4, 1536][6144, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_1, %primals_2), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(3):
            ...
            triton_poi_fused_add_0.run(primals_1, primals_2, buf0, 25165824, stream=stream3)
            del primals_1
            del primals_2
        return (buf0, )
